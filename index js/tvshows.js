...
{id:22,title:"Jodha Akbar",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-447/portrait/1920x770086b8e66e4e041e998bb1c0656bfc9f5.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:23,title:"Qubool Hai",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-135/portrait/1920x7708b572ba26c2b45969a993ccb59e197b9.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:24,title:"Ghar Ki Lakshmi Betiyaan",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-319/portrait/1920x7701501891863.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:25,title:"Zee Tv Uncut",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-4z5222846/portrait/1920x77001f8704f48bb47108bb60db62699aebe.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:26,title:"Jhansi Ki Rani",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-124/portrait/1920x770224b02ffbab04efdbeda2b6d4158d8fa.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:27,title:"Doosri Maa",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-4z5210380/portrait/1920x7700a6977594b4a44bab87fbff62e7babd4.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:28,title:"Sanjog",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-4z5185799/portrait/1920x77004de2cd79f82495680306538cb155cae.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:29,title:"Zindai Ki Mehak",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-271/portrait/1920x770a22111281c6f4f5cad22df60676ce231.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
{id:30,title:"Pavitra Rishta",
image:"https://akamaividz2.zee5.com/image/upload/w_504,h_756,c_scale,f_webp,q_auto:eco/resources/0-6-133/portrait/1920x77009472dd47ef9484fac3a7180534232ae51b7f45a98734523bb84463964cb1ddd.jpg",
category:"TV-Shows",
sub_category:"Popular Free Shows on ZEE5"},
]
...
let x=home_slide.length;
    ...
    display(home_slide);
        ...
        displayhome(tvshows1);
        function displayhome(tvshows1){
            tvshows1.forEach(element => {
            let div=document.createElement("div");
        ...
        displaylatest(tvshows2);
        function displaylatest(tvshows2){
            tvshows2.forEach(element => {
            let div=document.createElement("div");
            div.setAttribute("class","swiper-slide")
            let image=document.createElement("img");
            image.setAttribute("src",element.image)
        ...
        displaytop10(tvshows3);
        function displaytop10(tvshows3){
            tvshows3.forEach(element => {
            let div=document.createElement("div");
            div.setAttribute("class","swiper-slide")
            let image=document.createElement("img");
            image.setAttribute("src",element.image)
